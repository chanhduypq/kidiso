    	...
    	<div class="content">
        	<div class="body_content">
            	<div class="box_content">
                    <h2 class="fonth2">
                    Estrategia para reducir el consumo de la energía eléctrica
                    </h2>
                    <h3 class="fonth3 nobg">Reconocimiento de la situación ① (Antes de la estrategia)</h3>
                    <h4 class="fonth4">Hoja de análisis para el hogar</h4>
                    <p>Observá con atención las acciones llevadas adelante en tu hogar con respecto al ahorro de energía eléctrica. 
Colocá en el casillero el número que corresponda.
</p>
					<div class="table_form">
                    	<p style="text-align:center"><img src="<?php echo $this->webroot ?>img/images/smile.png"></p>
                    ...
                    <p class="txt_tab">Tachá con una línea los ítems que no concuerden con los hábitos de tu casa, y agregá en los espacios 
vacíos aquellos que quieras mencionar.</p>
                </div>
                <div class="clear"></div>
                <div class="btn_home">
                	<a href="" class="but_footer"><?php echo PREVIOUS;?></a>
