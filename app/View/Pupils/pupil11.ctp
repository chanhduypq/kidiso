    	...
    	<div class="content">
        	<div class="body_content">
            	<div class="box_content">
                    ...
                    <h4 class="fonth4 fz14">Si tenés medidor de electricidad en tu hogar, tomá como referencia las páginas 6 y 7 y registrá
los datos numéricos del medidor.<br>
Recordá pedirle a un adulto que te acompañe. </h4>
<p></p>
                    <p><img src="<?php echo $this->webroot ?>img/images/top_11.png"></p>
...
la semana</th>
                    ...
                    <div class="footer11">
                    	<h2>Algunos consejos útiles</h2>
                        <div class="img"><img src="<?php echo $this->webroot ?>img/images/11_b.png"></div>
                    </div>
                </div>
                <div class="clear"></div>
                <p></p>
