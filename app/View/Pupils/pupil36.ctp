    	...
    	<div class="content">
        	<div class="body_content">
            	<div class="box_content">
                    ...
                    <tbody><tr>
                    <td width="80%">
                    	<h3 class="fonth3 nobg"><img src="<?php echo $this->webroot ?>img/images/a_blue.png"> Actuar (Act)</h3>
...
Escribí cuáles fueron tus logros a partir de las estrategias que pensaste y qué cosas no pudiste mejorar.</h4>
                ...
                <div class="clear"></div>
                <div class="btn_home">
                	<a href="35.html" class="but_footer"><?php echo PREVIOUS;?></a>
