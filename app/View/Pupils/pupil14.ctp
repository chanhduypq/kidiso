    	...
    	<div class="content">
        	<div class="body_content">
            	<div class="box_content">
                	<h2 class="fonth2">
                    Estrategia para reducir el consumo de la energía 
eléctrica
                    </h2>
                	<h3 class="fonth3">Reconocimiento de la situación ① (Después de la estrategia)</h3>
                ...
                <div class="clear"></div>
                <div class="btn_home">
                	<a href="13.html" class="but_footer"><?php echo PREVIOUS;?></a>
