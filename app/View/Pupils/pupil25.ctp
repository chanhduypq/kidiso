...
resultados de la estrategia
                  ...
                  <p>Puntaje total</p>
                    <div class="table_form">
                      ...
                      <p class="txt_tab">Copiá los valores de las páginas 20 y 24</p>
                    </div>
                    ...
                    <td rowspan="2"><div class="center"><img src="<?php echo $this->webroot ?>img/images/mt_yellow.png"></div></td>
                    </tr>
                    <tr>
                    ...
                    <p></p>
                    <p></p>
                  <h3 class="fonth3 nobg">Medidor de gas</h3>
                  <p>Poné un círculo en el tipo de gas que utilizan en tu casa.   [  Gas natural · Gas de garrafa  ] </p>
...
<div class="center"><img src="<?php echo $this->webroot ?>img/images/2.png"></div>
                    ...
                    <tr>
                    <td class="bg_orange">Diferencia de
valores de
consumo
<div class="center"><img src="<?php echo $this->webroot ?>img/images/2.png"> - <img src="<?php echo $this->webroot ?>img/images/1.png"></div>
                    ...
                    <p class="txt_tab">
                    	Copiá los valores de las páginas 21 y 23
                    </p>
                    <p></p>
                    <div class="right">
...
estrategia</td>
                ...
                <div class="clear"></div>
                <div class="btn_home">
                	<a href="24.html" class="but_footer"><?php echo PREVIOUS;?></a>
