    	...
    	<div class="content">
        	<div class="body_content">
            	<div class="box_content">
                    ...
                    <p>
                    Observá con atención las acciones llevadas adelante en tu hogar con respecto al ahorro del agua. Colocá en el casillero el número que corresponda.
					</p>
                ...
                <div class="clear"></div>
                <div class="btn_home">
                	<a href="28.html" class="but_footer"><?php echo PREVIOUS;?></a>
