...
el ahorro de gas
                    ...
                    <p>Observá con atención las acciones llevadas adelante en tu hogar con respecto al ahorro de gas. Colocá en el casillero el número que corresponda.

</p>
					<div class="table_form">
                    	<p style="text-align:center"><img src="<?php echo $this->webroot ?>img/images/20-1.png"></p>
                ...
                <div class="clear"></div>
                <div class="btn_home">
                	<a href="18.html" class="but_footer"><?php echo PREVIOUS;?></a>
