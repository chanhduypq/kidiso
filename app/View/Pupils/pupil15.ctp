    	...
    	<div class="content">
        	<div class="body_content">
            	<div class="box_content">
                	<h2 class="fonth2">
                    Vamos a comparar los resultados de la estrategia
                  </h2>
                	<h3 class="fonth3"><img src="<?php echo $this->webroot ?>img/images/c.png"> Verificar (Check)</h3>
                  ...
                  <p>Puntaje total</p>
                    <div class="table_form">
                      ...
                      <p class="txt_tab">Copiá los valores de las páginas 10 y 14</p>
                    </div>
                    <table cellpadding="0" cellspacing="0" width="100%">
                    <tbody><tr>
                    <td width="80%">
                    	<h2>Compará los valores de antes y durante la estrategia</h2>
                    </td>
                    <td rowspan="2"><div class="center"><img src="<?php echo $this->webroot ?>img/images/mt.png"></div></td>
                    </tr>
                    <tr>
                    ...
                    <p></p>
                    <p></p>
                  <h3 class="fonth3">Medidor de electricidadtt</h3>
...
<div class="center"><img src="<?php echo $this->webroot ?>img/images/2.png"> - <img src="<?php echo $this->webroot ?>img/images/1.png"></div>
                    ...
                    <p class="txt_tab">
                    	Copiá los valores de las páginas 11 y 13
                    </p>
                    <p></p>
                    <div class="right">
...
estrategia</td>
                ...
                <div class="clear"></div>
                <div class="btn_home">
                	<a href="14.html" class="but_footer"><?php echo PREVIOUS;?></a>
