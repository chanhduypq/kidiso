    	...
    	<div class="content">
        	<div class="body_content">
            	<div class="box_content">
                	<h2 class="fonth2">Este espacio es para que tus
padres o algún miembro de la
familia te escriban un mensaje.</h2>
					<p></p>
                    <p></p>
                ...
                <div class="clear"></div>
                <div class="btn_home">
                	<a href="#" class="but_footer"><?php echo SAVE;?></a>
                	<a class="but_footer but_footer_save">FINISH</a>
                    <div class="clear"></div>
                </div>
            </div>
        </div>
