...
<div class="modal-header">
    ...
    <h4 class="modal-title" id="modal-title"><?php echo __('Add Pupil'); ?></h4>
</div>
<div class="modal-body" id="modal-body">
	...
	<div class="form-group">
	    <div class="input-group" style="width: 100%;">
	        ...
	        <?php echo $this->Form->input('pupil_password', array('type' => 'password', 'class' => 'form-control', 'placeholder' => 'Password', 'label' => false, 'div' => false)); ?>
	    </div>
	</div>
	<div class="form-group">
	    <div class="input-group" style="width: 100%;">
	        <label class="input-group-addon-1" style=""><?php echo __('Confirm Password'); ?></label>
	        <?php echo $this->Form->input('pupil_password_confirm', array('type' => 'password', 'class' => 'form-control', 'placeholder' => 'Confirm password', 'label' => false, 'div' => false)) ?>
	    </div>
	</div>
	<div class="form-group">
	    <div class="input-group" style="width: 100%;">
    ...
    <div class="form-group">
        <div class="input-group" style="width: 100%;">
            ...
            <?php echo $this->Form->input('classes_id', array('label'=>false,'div'=>false, 'class' => 'form-control', 'options' => $classes)); ?>
        </div>
    </div>
