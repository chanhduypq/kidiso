...
<div class="modal-header">
    ...
    <h4 class="modal-title" id="modal-title"><?php echo __('Edit Teacher'); ?></h4>
</div>
<div class="modal-body" id="modal-body">
	...
	<div class="form-group">
	    <div class="input-group" style="width: 100%;">
	        ...
	        <?php echo $this->Form->input('instructor_password_confirm', array('type' => 'password', 'class' => 'form-control', 'placeholder' => 'Confirm password', 'label' => false, 'div' => false, 'value' => $this->request->data['Instructor']['instructor_password'])) ?>
	    </div>
	</div>
	<div class="form-group">
	    <div class="input-group" style="width: 100%;">
	        <label class="input-group-addon-1" style=""><?php echo __('Birthday'); ?></label>
	        <?php echo $this->Form->input('birthday', array('type' => 'text', 'class' => 'form-control', 'placeholder' => 'Enter birthday', 'label' => false, 'div' => false, 'value' => date('Y/m/d', strtotime($this->request->data['Instructor']['birthday'])))); ?>
	    </div>
	</div>
	<div class="form-group">
        <div class="input-group" style="width: 100%;">
    ...
    <!-- <div class="form-group">
        <div class="input-group" style="width: 100%;">
            ...
            <?php echo $this->Form->input('district_id', array('label'=>false,'div'=>false, 'class' => 'form-control', 'options' => $districts, 'selected' => $this->request->data['School']['district_id'])); ?>
        </div>
    </div>
    <div class="form-group">
        <div class="input-group" style="width: 100%;">
            <label class="input-group-addon-1" style=""><?php echo __('School'); ?></label>
            <?php echo $this->Form->input('school_id', array('label'=>false,'div'=>false, 'class' => 'form-control', 'options' => $schools, 'selected' => $this->request->data['Instructor']['school_id'])); ?>
        </div>
    </div> -->
