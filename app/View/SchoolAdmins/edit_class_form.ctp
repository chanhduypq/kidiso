...
<div class="modal-header">
    ...
    <h4 class="modal-title" id="modal-title"><?php echo __('Edit Class'); ?></h4>
</div>
<div class="modal-body" id="modal-body">
    ...
    <div class="form-group">
        <div class="input-group" style="width: 100%;">
            ...
            <?php echo $this->Form->input('class_name', array('label'=>false,'div'=>false, 'class' => 'form-control')); ?>
        </div>
    </div>
    <div class="form-group">
        <div class="input-group" style="width: 100%;">
    ...
    <!-- <div class="form-group">
        <div class="input-group" style="width: 100%;">
            ...
            <?php echo $this->Form->input('district_id', array('label'=>false,'div'=>false, 'class' => 'form-control', 'selected' => $this->request->data['School']['district_id'])); ?>
        </div>
    </div>
    <div class="form-group">
        <div class="input-group" style="width: 100%;">
            <label class="input-group-addon-1" style=""><?php echo __('School'); ?></label>
            <?php echo $this->Form->input('school_id', array('label'=>false,'div'=>false, 'class' => 'form-control', 'selected' => $this->request->data['Classes']['school_id'])); ?>
        </div>
    </div> -->
    <div class="form-group">
        <div class="input-group" style="width: 100%;">
            <label class="input-group-addon-1" style=""><?php echo __('Teacher'); ?></label>
            <?php echo $this->Form->input('instructor_id', array('label'=>false,'div'=>false, 'class' => 'form-control', 'selected' => $this->request->data['Classes']['instructor_id'])); ?>
        </div>
    </div>
...
var submitForm = true;
    ...
    $('#ClassesClassName').change(function() {
        var schoolId = $('#ClassesSchoolId').val();
