...
<?php echo $this->Form->create('Pdca'); ?>
	<fieldset>
		<legend><?php echo __('Edit Pdca'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('Pdca.id')), array(), __('Are you sure you want to delete # %s?', $this->Form->value('Pdca.id'))); ?></li>
