...
datePicker.months       = ["enero","febrero","marzo","abril","coser","junio","julio","agosto","septiembre","octubre","noviembre","diciembre"];
datePicker.fullDay      = ["Lunes","Martes","Miércoles","Jueves","Viernes","Sábado","Domingo"];
datePicker.titles       = ["Anterior mes","Siguiente mes","Anterior año","Siguiente año", "Hoy", "Show Calendario"];
...
//                        
//
//                        input.className = "w50 w8em format-d-m-y highlight-days-67 range-low-today";
//                        
//
//                        input.id =  o.id;
//                        
//
//                        if(inp.nextSibling) {
//                                inp.parentNode.insertBefore(input, inp.nextSibling);
//                        } else {
//                                inp.parentNode.appendChild(input);
//                        };
//                } else {                        
//                        input = document.getElementById(o.id);
//                };
                input.onclick = input.onpress = function(e) {
                        e = e || window.event;
                        var inpId = this.id;
                        try { var dp = datePickerController.getDatePicker(inpId); } catch(err) { return false; };
